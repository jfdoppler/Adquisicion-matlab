...
nombreave='BV-VeRo'; %identificación del pájaro a grabar
save_vs=1; %1 to save the vS channel, 0 don't save
playback=1; %should the script do a nighttime playback protocol
...
s_trigger=0.2; %triger voltage value for sound channel
s_integral_threshold= 400; %threshold of integrated abs value in a tiempo ventana
